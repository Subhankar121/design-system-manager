...
export function ThemedStage({ tokens, children, mode = 'light' }: { tokens: TokenValueMap; children: React.ReactNode; mode?: 'light' | 'dark' }) {
  const theme = useMemo(() => tokensToMuiTheme(tokens, mode), [tokens, mode]);
  return (
